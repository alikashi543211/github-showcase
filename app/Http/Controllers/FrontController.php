...
class FrontController extends Controller
{
    public function index()
    {
        ...
        $wallpaper_image = 'assets/images/Github-Showcase-WallPaper.png';
        $profile_image = 'assets/images/kashif-dp.png';
        ...
        if (isset($wallpaper_image_db) && !empty($wallpaper_image_db)) {
            $wallpaper_image = $wallpaper_image_db->value;
        }
        ...
        if (isset($profile_image_db) && !empty($profile_image_db)) {
            $profile_image = $profile_image_db->value;
        }
